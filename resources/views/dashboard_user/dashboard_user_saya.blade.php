...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/dashboard_user_saya.css') }}">
...
<body>
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Daftar Survei Saya</h5>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2024-11-01</td>
                        <td>
                            <button class="btn btn-sm btn-primary">Lihat Survei</button>
                            <button class="btn btn-sm btn-info">Jawaban Responden</button>
                            <button class="btn btn-sm btn-danger">Ajukan Untuk Hapus</button>
                        </td>
                    </tr>
                    <tr>
